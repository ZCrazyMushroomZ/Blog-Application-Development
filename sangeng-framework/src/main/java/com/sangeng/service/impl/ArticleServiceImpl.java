...
//        }
    ...
    public ResponseResult getArticleDetail(Long id) {
        ...
        //从redis中获取viewCount
        Integer viewCount = redisCache.getCacheMapValue(SystemConstants.ARTCLE_VIEWCOUNT, id.toString());
    ...
    public ResponseResult updateViewCount(Long id) {
        //更新redis中对应 id的浏览量
        redisCache.incrementCacheMapValue(SystemConstants.ARTCLE_VIEWCOUNT,id.toString(),1);
...
//        save(article);
    ...
    public ResponseResult deleteByIds(List<Long> ids) {
        ids.stream().forEach(id -> articleService.removeById(id));
        return ResponseResult.okResult();
    }
}
